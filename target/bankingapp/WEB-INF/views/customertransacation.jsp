...
<body>
			...
			<div class="text-center  ">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="logout">About</a></li>
	...
	<% String acc = (String) request.getParameter("accountNumber");
		...
		%>
	<a href="downloadTransactions?accountNumber=<%=acc%>">Download Transaction Table</a>
		<form action="custvalid">  <button type="submit">Back</button> </form>
	...
	<div class="container m-5">
		...
		<!-- Rest of your transaction table rendering code -->
	</div>
